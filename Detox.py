...
class DigitalDetoxAssistant:
    def __init__(self, root):
        ...
        self.alert_btn = tk.Button(self.frame, text="⚠️ Show Alert", command=self.show_alert, font=("Arial", 12), bg="#e74c3c", fg="white", padx=10, pady=5)
    ...
    def show_alert(self):
        ...
        if elapsed_time >= self.usage_limit:
            messagebox.showwarning("⚠️ Warning", "You've been on the screen too long! Time for a break.")
        else:
